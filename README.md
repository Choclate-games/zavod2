...
- **Десктопный GUI на CustomTkinter** (главное приложение, `python gui.py`):
...
Внутренний браузер использует `pywebview`, если он установлен; иначе игра
открывается в отдельном окне Edge/Chrome (`--app`), а в крайнем случае — в
системном браузере.
