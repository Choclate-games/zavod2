...
def fallback_catalog(theme_hint: str = "", count: int = 10) -> List[BrainstormedIdea]:
    ...
    локального провайдера, чтобы список идей был один и тот же.
    """
    catalog = [
        BrainstormedIdea(
        ...
        BrainstormedIdea(
            title="🏗️ Небесный Кран: Башня Хаоса",
            genre="3D Физическая Аркада / Строительство",
            hook="Раскачивающийся кран, ветер и настоящая физика падающих блоков",
            pitch="Ставьте блоки друг на друга на качающемся тросе, гасите раскачку и стройте башню выше рекорда соседей.",
            renderer="threejs",
            platform_fit="Яндекс Игры / Портретный режим",
            prompt_seed="3D физическая аркада про строительство башни краном на Three.js: раскачка троса, ветер, разрушаемая конструкция и лидерборд высоты"
        ),
        BrainstormedIdea(
            title="🚇 Метро-Паркур: Побег 3D",
            genre="3D Раннер / Паркур",
            hook="Процедурные тоннели, слоу-мо подкаты и разрушаемые препятствия",
            pitch="Бегите по заброшенной подземке, уворачивайтесь от поездов, собирайте импульс и открывайте новых бегунов.",
            renderer="threejs",
            platform_fit="Мобильный браузер (свайпы)",
            prompt_seed="3D бесконечный раннер-паркур в метро на Three.js со свайп-управлением, процедурными тоннелями и магазином персонажей"
        ),
        BrainstormedIdea(
            title="🍜 Кибер-Лапшичная: Тайм-менеджмент",
            genre="2D Тайм-менеджмент / Симулятор кафе",
            hook="Роботы-повара, комбо за скорость подачи и апгрейд кухни",
            pitch="Готовьте заказы киберпанк-клиентам, укладывайтесь в таймер и прокачивайте линию до полной автоматизации.",
            renderer="pixijs",
            platform_fit="Яндекс Игры / ПК и мобильные",
            prompt_seed="2D тайм-менеджмент про киберпанк-лапшичную на PixiJS: очередь клиентов, комбо за скорость, апгрейды кухни и Rewarded видео за ускорение"
        ),
        BrainstormedIdea(
            title="🛡️ Осада Башни: Тактика Рун",
            genre="2D Tower Defense / Рогалит",
            hook="Руны комбинируются прямо на башнях, меняя тип урона в бою",
            pitch="Расставляйте башни, сплавляйте руны в стихийные комбо и держите оборону против 20 волн с боссами.",
            renderer="pixijs",
            platform_fit="Яндекс Игры / Планшеты",
            prompt_seed="2D tower defense с рунной прокачкой башен, стихийными комбо, процедурными волнами и боссами на PixiJS"
        ),
        BrainstormedIdea(
            title="🐙 Глубина: Батискаф-Выживание 3D",
            genre="3D Исследование / Выживание",
            hook="Давление, кислород и свет прожектора как ресурсы, темнота как враг",
            pitch="Погружайтесь в океанский разлом, добывайте ресурсы, чините батискаф и прячьтесь от того, что живёт глубже.",
            renderer="threejs",
            platform_fit="Яндекс Игры / ПК",
            prompt_seed="3D игра про погружение батискафа на Three.js: ограниченный кислород и свет, добыча ресурсов, апгрейды корпуса и напряжённое исследование глубин"
        )
    ]
