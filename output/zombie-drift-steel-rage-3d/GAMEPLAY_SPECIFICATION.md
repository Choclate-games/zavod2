# Gameplay Specification: Зомби Дрифт: Стальная Ярость 3D

## 1. Overview
This document specifies the exact mechanical logic, mathematical formulas, state transitions, and feedback loops powering `Зомби Дрифт: Стальная Ярость 3D`.
