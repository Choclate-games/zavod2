...
class LocalAIProvider(AIProvider):
    ...
    _GENERIC_PROFILES = {
        "kitchen": {
            ...
            "mechanic_name": "Сборка заказа по шагам",
            "mechanic_category": "core",
            "mechanic_desc": "Каждое блюдо собирается последовательностью действий; точный порядок и тайминг дают множитель.",
            "mechanic_feedback": "Пар, звук шипящей сковороды, довольный гость и всплывающий множитель комбо.",
        },
        "nature": {
            "renderer": "pixijs",
            ...
            "mechanic_name": "Распределение ролей и маршрутов",
            "mechanic_category": "progression",
            "mechanic_desc": "Игрок не управляет каждым жителем: он задаёт приоритеты и маршруты, а колония исполняет их с задержкой.",
            "mechanic_feedback": "Оживающие тропы, растущие постройки, наглядные счётчики прироста и убыли.",
        },
        "ocean": {
            "renderer": "threejs",
            ...
            "mechanic_name": "Управление светом и воздухом",
            "mechanic_category": "core",
            "mechanic_desc": "Прожектор, двигатели и приборы делят один запас энергии; игрок постоянно решает, что выключить.",
            "mechanic_feedback": "Гаснущий свет, нарастающий скрип корпуса, показания приборов и тишина вместо музыки.",
        },
        "winter": {
            "renderer": "pixijs",
            ...
            "mechanic_name": "Бюджет дня и тепло",
            "mechanic_category": "core",
            "mechanic_desc": "Часы дня — главный ресурс: каждое действие тратит время и тепло, а ночь наступает по расписанию.",
            "mechanic_feedback": "Пар от дыхания, гаснущий очаг, иней по краям экрана и звук вьюги.",
        },
        "space": {
            "renderer": "threejs",
            ...
            "mechanic_name": "Перемещение импульсами в невесомости",
            "mechanic_category": "movement",
            "mechanic_desc": "Ранец даёт короткие импульсы; траектория рассчитывается заранее, а торможение стоит столько же, сколько разгон.",
            "mechanic_feedback": "Струи двигателя, вращение сцены вокруг игрока, показания расхода топлива и стук по обшивке.",
        },
        "city": {
            "renderer": "threejs",
            ...
            "mechanic_name": "Физика груза и маршрут",
            "mechanic_category": "movement",
            "mechanic_desc": "Груз в кузове реагирует на ускорение и повороты; безопасная скорость зависит от того, что везёте.",
            "mechanic_feedback": "Смещение груза в кадре, скрип креплений, индикатор целостности и таймер окна доставки.",
        },
        "detective": {
            "renderer": "pixijs",
            ...
            "mechanic_name": "Доска улик и связи",
            "mechanic_category": "core",
            "mechanic_desc": "Игрок соединяет показания и улики: верная связь открывает вопрос, ошибочная тратит ограниченный ресурс времени.",
            "mechanic_feedback": "Натягивающаяся нить, подсветка противоречия, новая реплика свидетеля.",
        },
        "music": {
            "renderer": "pixijs",
            ...
            "mechanic_name": "Удержание такта и ввод партий",
            "mechanic_category": "core",
            "mechanic_desc": "Точность попадания в долю влияет на всю сцену: партии подстраиваются под темп игрока с задержкой.",
            "mechanic_feedback": "Пульс интерфейса в такт, вспышка на точной доле, глухой звук на промахе.",
        },
        "generic": {
            ...
            "mechanic_name": "Основная механика и управление",
            "mechanic_category": "core",
            "mechanic_desc": "Интуитивное управление с мгновенным откликом, честными коллизиями и растущей глубиной мастерства.",
            "mechanic_feedback": "Частицы при попадании, лёгкая тряска камеры и звуковой акцент на важном событии.",
        },
    }
    ...
    def _synthesize_concept(self, raw_prompt: str) -> GameConcept:
        ...
        if is_drift:
            ...
            mechanics = [
                MechanicSpec(
                    name=profile["mechanic_name"],
                    category=profile["mechanic_category"],
                    priority="core",
                    description=profile["mechanic_desc"],
                    player_interaction="Виртуальный джойстик и кнопки действий на экране, на ПК — клавиатура и мышь.",
                    feedback=profile["mechanic_feedback"],
                    technical_complexity="Medium",
