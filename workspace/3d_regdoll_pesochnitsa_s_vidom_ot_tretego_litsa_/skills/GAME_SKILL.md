# Skill: Банкетный Краш: Свадебный Саботаж Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Банкетный Краш: Свадебный Саботаж.
