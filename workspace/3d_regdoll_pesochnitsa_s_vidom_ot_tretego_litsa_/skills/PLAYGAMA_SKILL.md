...
- `docs/ref/knowledge/ux/input_scheme_switching.md` — Две схемы управления: ПК и мобильные, переключение по `bridge.device.type` — Игра фабрики выпускается сразу на площадки, где рядом сидят игрок с клавиатурой и игрок с телефоном. Значит, **схем управления всегда две**…
