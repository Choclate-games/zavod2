# Mobile Controls & Ergonomics: Муравьиный Рой: Война Колоний

Профиль управления: **builder** (определён по жанру «Стратегия в реальном времени»).

## 1. Orientation & Layout
- **Target Orientation**: **LANDSCAPE**
- **Safe Area Insets**: `Автоматические CSS env(safe-area-inset-*) отступы для кнопок интерфейса и динамический viewport без обрезки игрового поля.`
