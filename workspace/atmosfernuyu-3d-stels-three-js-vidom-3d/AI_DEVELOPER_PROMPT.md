# FINAL AI DEVELOPER PROMPT: АТМОСФЕРНУЮ 3D-СТЕЛС THREE.JS ВИДОМ 3D 🎮⚡
...
- **Game Title**: Атмосферную 3d-стелс three.js видом 3D
- **Project Slug**: `atmosfernuyu-3d-stels-three-js-vidom-3d`
...
Проект живёт в песочнице `workspace/atmosfernuyu-3d-stels-three-js-vidom-3d/`, и вся работа за её пределы
