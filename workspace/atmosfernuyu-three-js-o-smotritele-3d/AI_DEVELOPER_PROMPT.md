# FINAL AI DEVELOPER PROMPT: АТМОСФЕРНУЮ THREE.JS О СМОТРИТЕЛЕ 3D 🎮⚡
...
- **Game Title**: Атмосферную three.js о смотрителе 3D
- **Project Slug**: `atmosfernuyu-three-js-o-smotritele-3d`
...
**Дизайн-ядро проекта**: Свет, воздух и прочность корпуса — три счётчика, которые нельзя тратить одновременно.
...
### Управление светом и воздухом (CORE)
- **Category**: core
...
- **Hit & Sensory Feedback**: Гаснущий свет, нарастающий скрип корпуса, показания приборов и тишина вместо музыки.
...
Проект живёт в песочнице `workspace/atmosfernuyu-three-js-o-smotritele-3d/`, и вся работа за её пределы
...
- **Style**: Тёмная толща воды и конус прожектора
