# Skill: Physics Vehicle & Cargo Controller

## Purpose
Задаёт обязательную архитектуру машины на физике: raycast-подвеска, риг колёс внутри кузова, составной коллайдер с бортами и груз, который остаётся в кузове.
...
## System Architecture
TruckController владеет chassis RigidBody, составным коллайдером и DynamicRayCastVehicleController.

## Implementation Guidance
Тюнинг подвески: статическая просадка ≈ gravity / stiffness, restLength > просадки.

## Common Mistakes to Avoid
- ❌ **Mistake**: setLinvel каждый кадр: машина едет вдоль мировой оси, подвески нет.
- ❌ **Mistake**: Луч колеса без фильтра групп — машина встаёт на собственный груз.
