# Skill: Куриный Побег 3D: Стелс на Ферме Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Куриный Побег 3D: Стелс на Ферме.
