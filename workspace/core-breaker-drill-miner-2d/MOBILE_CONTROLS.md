# Mobile Controls & Ergonomics: Бурильщик Бездны: Рикошет Руды

Профиль управления: **default** (определён по жанру «2D Экшен-рогалик / Майнер»).

## 1. Orientation & Layout
- **Target Orientation**: **PORTRAIT**
- **Safe Area Insets**: `Автоматический CSS/Canvas отступ под вырезы камеры (Notch) и системный нижний Home Bar.`
