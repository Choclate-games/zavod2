# Skill: CYBER SLICE: BULLET PROTOCOL (Кибер Срез: Протокол Времени) Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for CYBER SLICE: BULLET PROTOCOL (Кибер Срез: Протокол Времени).
