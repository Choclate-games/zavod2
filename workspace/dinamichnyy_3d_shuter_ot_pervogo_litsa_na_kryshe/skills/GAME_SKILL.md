# Skill: Громовой Перехват: Штормовой Экспресс Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Громовой Перехват: Штормовой Экспресс.
