...
## Purpose
Документы базы знаний, выбранные куратором именно под эту игру: Проект опирается на связку высокоскоростного FPS-контроллера с баллистикой упреждения, роевого ИИ дронов с цепной детонацией, физики Rapier3D на крыше процедурного поезда и атмосферных VFX шторма; стандартные паттерны циклов исключены из-за формата линейного 80-секундного рейда с боссом..
...
- `mechanics/chain_reaction.md` — Физический каскад цепной детонации дронов роя при уничтожении командира с разлетом опасных горящих обломков.
- `mechanics/physics_destruction.md` — Разрушение сбитых дронов на физические обломки, превращающиеся в горящие препятствия на полосах движения.
- `audio/web_audio_and_muting.md` — Управление звуковым контекстом, автозапуск по клику и мгновенное глушение при потере фокуса вкладки.
- `monetization/interstitial_best_practices.md` — Показ межстраничной рекламы в естественных паузах между завершенными 80-секундными штурмовыми рейдами.
- `monetization/rewarded_ads_patterns.md` — Вознаграждаемая реклама за второй шанс при падении с поезда или мгновенную зарядку тесла-перегрузки перед боссом.

## Common Mistakes to Avoid
- ❌ **Mistake**: Реализовать механику по памяти, не открыв документ, который под неё выбран.
- ❌ **Mistake**: Притащить решение из документа, который куратор для этого проекта отклонил: threejs/horde_survivor_core.md, patterns/survivor_loop.md, patterns/arena_combat_loop.md, patterns/score_attack_loop.md, mechanics/upgrade_choices.md, mechanics/cover_and_suppression.md, threejs/rapier_vehicle_controller.md, stack/recast_navigation.md, threejs/melee_combat_and_ragdoll.md.
