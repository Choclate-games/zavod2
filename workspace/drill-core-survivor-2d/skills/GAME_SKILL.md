# Skill: Бур Судного Дня: Шахтерский Рогалик Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Бур Судного Дня: Шахтерский Рогалик.
