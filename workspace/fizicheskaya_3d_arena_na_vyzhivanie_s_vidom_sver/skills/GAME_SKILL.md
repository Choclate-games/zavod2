# Skill: Ледовый Сумо-Батл: Последний Тюбинг Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Ледовый Сумо-Батл: Последний Тюбинг.
