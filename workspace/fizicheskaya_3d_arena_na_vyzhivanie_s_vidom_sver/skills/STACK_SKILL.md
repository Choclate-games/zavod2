...
- `docs/ref/knowledge/stack/yuka_ai.md` — Yuka — игровой ИИ (`yuka@^0.7.8`) — Библиотека ИИ, независимая от рендерера: сущности, steering-поведения, конечные автоматы, нечёткая логика, восприятие (зрение + память). Своя математика «лети на игрока», свой `if…
