...
- `docs/ref/knowledge/stack/postprocessing.md` — postprocessing — графические эффекты (`postprocessing@^6.39.4`) — Библиотека pmndrs вместо `three/examples/jsm/postprocessing/*`. Ключевое отличие: `EffectPass` **сливает несколько эффектов в один шейдер и один…
