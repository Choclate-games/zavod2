# FINAL AI DEVELOPER PROMPT: ИЗОМЕТРИЧЕСКИЙ СТЕЛС-ЭКШЕН PIXI.JS: ПЕРСОНАЖ 🎮⚡
...
- **Game Title**: Изометрический стелс-экшен pixi.js: персонаж
- **Project Slug**: `izometricheskiy-stels-ekshen-pixi-js-per`
- **Genre**: 2D Менеджмент колонии / Idle-стратегия (Жизнь и рост поселения)
...
**Дизайн-ядро проекта**: Вы задаёте правила, а колония живёт сама и приносит последствия ваших решений.
...
### Распределение ролей и маршрутов (CORE)
...
- **Hit & Sensory Feedback**: Оживающие тропы, растущие постройки, наглядные счётчики прироста и убыли.
...
Проект живёт в песочнице `workspace/izometricheskiy-stels-ekshen-pixi-js-per/`, и вся работа за её пределы
...
- **Camera Perspective**: 2D камера с плавным следованием и лёгким параллаксом (FOV: 0°, Pitch: 0°)
