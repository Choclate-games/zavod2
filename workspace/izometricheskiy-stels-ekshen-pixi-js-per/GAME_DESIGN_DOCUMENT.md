# Game Design Document (GDD): Изометрический стелс-экшен pixi.js: персонаж

## 1. Executive Summary & Vision
- **Title**: Изометрический стелс-экшен pixi.js: персонаж
- **Vision Statement**: Создать качественную веб-игру на PIXIJS с понятной первой сессией и высоким удержанием.
