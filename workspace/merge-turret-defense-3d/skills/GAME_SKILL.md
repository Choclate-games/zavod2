# Skill: Слияние Турелей 3D: Оборона Базы Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Слияние Турелей 3D: Оборона Базы.
