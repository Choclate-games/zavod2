# Mobile Controls & Ergonomics: Ночной Спринт: Трафик и Закись

Профиль управления: **driving** (определён по жанру «3D Аркадный Автосимулятор / Уличные Гонки»).

## 1. Orientation & Layout
- **Target Orientation**: **LANDSCAPE**
- **Safe Area Insets**: `Автоматический отступ 44px слева и справа с помощью CSS env(safe-area-inset-*) для предотвращения перекрытия HUD вырезами камер (Notch) и системными полосами навигации iOS/Android.`
