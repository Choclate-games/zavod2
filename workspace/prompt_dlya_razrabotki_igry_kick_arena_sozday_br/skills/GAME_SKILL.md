# Skill: Судебный Пристав: Штурм Локдауна Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Судебный Пристав: Штурм Локдауна.
