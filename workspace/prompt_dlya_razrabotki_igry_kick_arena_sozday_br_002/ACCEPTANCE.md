# Приёмка: Вышибала: Сброс за борт
...
- [ ] **B9** · Экраны проекта существуют и переключаются по одному: Screen_HUD, Screen_UpgradeModal, Screen_VictorySummary, Screen_DefeatModal, Screen_LobbyArmory.
...
- [ ] **C5** · Сохранение — один ключ (`player_unlocked_weapons`), один JSON, нормализация при чтении; битый сейв поднимается на умолчаниях.
- [ ] **C6** · Награда за rewarded выдаётся только по `state === 'rewarded'` (Спасение при падении за борт), слушатель снимается через `off()`, повторный клик не платит дважды.
...
- [ ] **C9** · Возможность, которой на площадке нет, не нарисована вовсе — не серой кнопкой и не ошибкой по нажатию. Проверяется подменой флага (high_score_contract).
...
- [ ] **D1** · spartan_kick_ringout (Спартанский кинетический пинок за борт): ПК: Пробел (Space) — мгновенный пинок; Shift + Пробел — пинок с разбега с максимальным импульсом. Мобильные: Выделенная кнопка с иконкой тяжелого ботинка в правом нижнем углу экрана.\n- [ ] **D2** · chain_ragdoll_bowling (Цепной кегельбан рэгдоллов): Пассивная физическая механика, активируемая любым кинетическим воздействием на тела врагов (пинок, выстрел, бросок мебели).\n- [ ] **D3** · acoustic_pulse_blaster (Кинетический акустический бластер): ПК: Правая кнопка мыши (ПКМ) — кинетический акустический выстрел. Мобильные: Кнопка со значком звуковой волны над зоной атаки.\n- [ ] **D4** · environment_shatter_and_throw (Крушение интерьера и силовой бросок): ПК: Клавиша E — захват предмета / интеракция; ЛКМ/E при удерживании — силовой бросок по направлению взгляда; Q — сброс предмета под ноги. Мобильные: Контекстная кнопка захвата/броска над кнопкой атаки.\n- [ ] **D5** · edge_tension_footwork (Балансирование у края и тактический рывок): ПК: Клавиша Shift — направленный рывок (Dash) по вектору движения WASD; Двойное нажатие направления. Мобильные: Свайп в любую сторону по левой половине экрана.\n- [ ] **D6** · Условие успеха срабатывает: Зачистить все 4 волны контрактной сессии (всего 32 противника), сбросив за борт не менее 60% врагов, и сбросить босса-вышибалу с палубы в пропасть за время до 4 минут.\n- [ ] **D7** · Условие проигрыша срабатывает: Падение здоровья персонажа до 0 HP от атак киборгов или падение самого игрока за борт платформы в бездну (ринг-аут).
