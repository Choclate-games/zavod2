# Skill: Kick Arena: Кинетический Рикошет Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Kick Arena: Кинетический Рикошет.
