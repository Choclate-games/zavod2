# Mobile Controls & Ergonomics: Рикошет Снайпер 3D: Замедленный Выстрел

Профиль управления: **default** (определён по жанру «Физическая головоломка / Тактический 3D-шутер»).

## 1. Orientation & Layout
- **Target Orientation**: **LANDSCAPE**
- **Safe Area Insets**: `Динамические CSS отступы env(safe-area-inset-*) для корректного отображения HUD на экранах с вырезами (iPhone Notch/Dynamic Island) и скругленными углами.`
