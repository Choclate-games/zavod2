# Skill: Рикошет Снайпер 3D: Замедленный Выстрел Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Рикошет Снайпер 3D: Замедленный Выстрел.
