# Skill: Лесной Рейс: Доставка на Лесопилку 3D Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Лесной Рейс: Доставка на Лесопилку 3D.
