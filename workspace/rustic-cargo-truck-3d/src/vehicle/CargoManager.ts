...
export class CargoManager {
  ...
  constructor(private readonly physics: PhysicsWorld, private readonly scene: SceneManager, _events: EventBus) {}
  ...
  fixedUpdate(truckZ: number, events: EventBus): void {
  ...
  render(_alpha: number): void {
    for (const item of this.items) item.mesh.visible = item.active;
  }

  private logGeometry(): THREE.CylinderGeometry {
