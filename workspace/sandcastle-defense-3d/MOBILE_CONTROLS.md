# Mobile Controls & Ergonomics: Песочный Бастион 3D: Защита Пляжа

Профиль управления: **builder** (определён по жанру «Tower Defense (Защита башен)»).

## 1. Orientation & Layout
- **Target Orientation**: **LANDSCAPE**
- **Safe Area Insets**: `CSS env(safe-area-inset-*) для отступов панелей на экранах с вырезами (iPhone Notch / Dynamic Island).`
