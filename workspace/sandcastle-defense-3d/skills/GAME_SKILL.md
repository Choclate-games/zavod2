# Skill: Песочный Бастион 3D: Защита Пляжа Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Песочный Бастион 3D: Защита Пляжа.
