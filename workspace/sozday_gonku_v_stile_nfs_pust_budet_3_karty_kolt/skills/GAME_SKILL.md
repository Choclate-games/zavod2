# Skill: Ночной Синдикат: Дуэли и Контракты Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Ночной Синдикат: Дуэли и Контракты.
