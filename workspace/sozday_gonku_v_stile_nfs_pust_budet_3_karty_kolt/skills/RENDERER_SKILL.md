...
- `docs/ref/knowledge/threejs/racing_track_and_opponents.md` — Гонка на Three.js + Rapier 3D: трасса, круги, гоночная линия, VFX и соперники — Управление спорткаром и занос — в `arcade_racing_and_drift.md` и `rapier_vehicle_controller.md`. Общие принципы создания карт, рельефа и…
- `docs/ref/knowledge/threejs/vehicle_wheel_rig.md` — Three.js: риг колёс и сборка машины — Колёса — самая заметная деталь любой машины и самая частая визуальная ошибка процедурной геометрии. «Кривые колёса» почти всегда сводятся к четырём конкретным причинам ниже.
- `docs/ref/knowledge/threejs/game_map_and_world_design.md` — Дизайн и процедурная генерация игровых карт и миров (Three.js + Rapier 3D) — Руководство по созданию высокопроизводительных, стабильных и визуально безупречных игровых локаций (гоночные кольца, открытые полигоны…
