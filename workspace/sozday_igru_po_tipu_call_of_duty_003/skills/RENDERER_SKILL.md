...
- `docs/ref/knowledge/threejs/stealth_and_vision_cones.md` — Three.js: стелс, конусы зрения и шкала тревоги — Смежное: `knowledge/mechanics/stealth_detection.md` (спецификация каналов восприятия), `knowledge/stack/three_mesh_bvh.md` (лучи по статике), `knowledge/stack/yuka_ai.md`…
