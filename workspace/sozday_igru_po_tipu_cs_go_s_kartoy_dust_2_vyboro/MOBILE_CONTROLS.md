# Mobile Controls & Ergonomics: Dust 2: Ретейк и Дуэли

Профиль управления: **default** (определён по жанру «Тактический 3D FPS-Шутер»).

## 1. Orientation & Layout
- **Target Orientation**: **LANDSCAPE**
- **Safe Area Insets**: `Отступы HUD по 24px от краев экрана для предотвращения попадания под вырезы камер (Notch) и системные полосы жестов iOS/Android.`
