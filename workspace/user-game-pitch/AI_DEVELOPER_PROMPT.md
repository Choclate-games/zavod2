# FINAL AI DEVELOPER PROMPT: USER GAME PITCH: ТЕСТОВЫЙ 2D П 🎮⚡
...
- **Game Title**: User game pitch: тестовый 2d п
- **Project Slug**: `user-game-pitch`
- **Genre**: 2D Аркадный Экшен (Выживание на Арене)
...
- **Player Fantasy**: Погрузитесь в захватывающий мир игры, овладейте ключевыми механиками и побеждайте волны врагов.
- **Core Hook**: Динамичный игровой процесс с сочным физическим откликом, комбо-системами и рогалик-прокачкой.
...
**Core Loop Sequence**:
```text
Управление персонажем -> Уничтожение врагов -> Выбор 1 из 3 улучшений -> Битва с боссом -> Прокачка в меню.
```

### Основная Боевая Система и Управление (CORE)
- **Category**: combat
- **Description**: Интуитивное управление с мгновенным откликом, расчетом физических коллизий и комбо-сериями.
- **Player Input**: Виртуальный джойстик и кнопки действий на экране.
- **Hit & Sensory Feedback**: Вспышки частиц, вибрация экрана, звуковые акценты ударов.
...
Проект живёт в песочнице `workspace/user-game-pitch/`, и вся работа за её пределы
