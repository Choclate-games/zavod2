# User game pitch: тестовый 2d п 🎮

> **Захватывающий экшен с глубокой прокачкой, мгновенным стартом и сочным геймфилом!**

---

## 🌟 Project Overview
- **Genre**: 2D Аркадный Экшен (Выживание на Арене)
- **Renderer**: **PIXIJS** + Matter.js (^0.19.0)
