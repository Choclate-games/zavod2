# Skill: Воксельный Измельчитель ASMR 3D Domain Architecture

## Purpose
Defines domain rules, state machine, and core gameplay loop for Воксельный Измельчитель ASMR 3D.
